...
<div class="contenedor_loader">
    ...
    <!--NAVBAR-->
    <?php require 'navfree.php'; ?>

     <!--NAVBAR-->


  <!--TITLE-->
    <center><div class="card mt-2 py-3" style="width: 550px; height: auto; max-width: 100%; background-color: transparent; border-color: transparent;">
...
<div class="row row-cols-1 row-cols-md-2 g-4">
  <div class="col">
    <div class="card" style="background-color: transparent; border-color: transparent;">
      ...
      <div class="row row-cols-1 row-cols-md-2 g-4">
  <div class="col">
      <img src="img/zocalo.jpeg" class="card-img-top" alt="..."> </div>
      <div class="col">
...
<center><a href="zocalo.html" class="btn btn-warning" style="border-radius: 8px; width: 240px; font-weight: bold;">Mas sobre...</a></center>
      </div>
    </div>
  </div>
<!--EVENTO 1-->
...
<!--EVENTO 2-->
  <div class="col">
    <div class="card" style="background-color: transparent; border-color: transparent;">
      ...
      <h5 class="card-title bg-danger text-center text-light mt-2" style="border-radius: 30px; font-size: 25px;">Monumento a la Revolucion</h5>
      <div class="row row-cols-1 row-cols-md-2 g-4">
      <div class="col">
      <img src="img/revolucion.jpg" class="card-img-top" alt="..."></div>
      <div class="col">
...
<center><a href="rev.html" class="btn btn-warning" style="border-radius: 8px; width: 240px; font-weight: bold;">Mas sobre...</a></center>
      </div>
    </div>
  </div>
...
<center>
  <a href="rev.html" class="btn btn-dark" style="width: 300px;border-radius: 8px; font-size: 25px; font-weight: bold;">Ver más eventos...</a>
  </center>
