<div class="container col-6 p-2 " style="border: 10px solid; border-color: #900D09; height: 600px; width: 600px; margin-top: 40px; border-radius: 30px;"> 
    <div class="container-fluid col-md-8 ">
                <a href="appPerfil.php" id="Regresar" style="font-size: 25px; margin-top: 5px; background-color: transparent; color: #D0312D; text-decoration: none;">
    ...
    <form action="<?php echo $_SERVER['PHP_SELF']?>" method="POST">
                       ...
                       <!-- <div class="input-group md-3">
						...
						<div class="input-group mb-3">
							...
							<input type="text" name="Nombres" class="form-control" value="<?php echo $lista['Nombre']; ?>" placeholder="Nombre" aria-label="text" aria-describedaby="text" required>
						...
						<div class="input-group mb-3">
							...
							<input type="text" name="ApellidoP" class="form-control" value="<?php  echo $lista['ApellidoP'];  ?>" placeholder="Apellido Paterno" aria-label="text" aria-describedaby="text" required>
						...
						<div class="input-group mb-3">
							...
							<input type="text" name="Email" class="form-control" value="<?php  echo $lista['Email'];  ?>" placeholder="Apellido Paterno" aria-label="text" aria-describedaby="text" required>
							<div class="valid-feedback"> Apellido Valido</div>
							<div class="invalid-feedback"> Agregar Apellido</div>
						</div>
