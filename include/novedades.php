...
<!--TITLE-->
<center>
  <div class="card mt-2 py-3 mb-4" style="width: 550px; height: auto; max-width: 100%; background-color: transparent; border-color: transparent;">
    <div class="card-body bg-dark text-light" style="font-weight: bold; border-radius: 30px; font-size: 55px;">
      <img class="me-1 py-3" src="img/icono.png" alt="" width="40px">
      NOVEDADES
      <img src="img/icono.png" alt="" width="40px">
      <font color="crimson">
        <p class="card-title bg-danger" style="width: 500px; height: 20px; border-radius: 30px; font-size: 30px;"></p>
      </font>
    </div>
  </div>
</center>
...
<div class="row row-cols-1 row-cols-md-2 g-4">
  <div class="col">
    <div class="card" style="background-color: transparent; border-color: transparent;">
      ...
      <div class="row row-cols-1 row-cols-md-2 g-4">
        <div class="col">
          <img src="img/img_lugares/<?php echo $delt['Img']; ?>" class="card-img-top" alt="..." height="210px">
        </div>
        <div class="col">
  ...
  <div class="col">
    <div class="card" style="background-color: transparent; border-color: transparent;">
      ...
      <div class="row row-cols-1 row-cols-md-2 g-4">
        <div class="col">
          <img src="img/img_lugares/<?php echo $esc['Img']; ?>" class="card-img-top" alt="..." height="210px">
        </div>
        <div class="col">
      ...
      <div class="card-body">
        ...
        <p class="card-text">Este año la Pista de Hielo que mide 200 metros cuadrados que se instalo en la explanada del Monumento a la Revolución, a un costado se coloco un árbol navideño y adornos navideños.<br>
...
<div class="row row-cols-1 row-cols-md-2 g-4">
  <div class="col">
    <div class="card" style="background-color: transparent; border-color: transparent;">
      ...
      <div class="row row-cols-1 row-cols-md-2 g-4">
        <div class="col">
          <img src="img/img_lugares/<?php echo $pink['Img']; ?>" class="card-img-top" alt="..." height="210px">
        </div>
        <div class="col">
          <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d15050.129382642193!2d-99.1332049!3d19.4326018!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x4cff0c5cb291360c!2zWsOzY2Fsbw!5e0!3m2!1ses-419!2smx!4v1669860326181!5m2!1ses-419!2smx" style="border:0; height: auto; max-width: 100%; height: 210px; width: 320px;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
        </div>
  ...
  <div class="col">
    <div class="card" style="background-color: transparent; border-color: transparent;">
      ...
      <div class="row row-cols-1 row-cols-md-2 g-4">
        <div class="col">
          <img src="img/img_lugares/<?php echo $tier1['Img']; ?>" class="card-img-top" alt="..." height="210px">
        </div>
        <div class="col">
          <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d3762.444555148869!2d-99.15354677309392!3d19.436390816425003!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0xf5a2e71b8beeb3d6!2sPlaza%20de%20la%20Rep%C3%BAblica!5e0!3m2!1ses-419!2smx!4v1669861135129!5m2!1ses-419!2smx" style="border:0; height: auto; max-width: 100%; height: 210px; width: 316px;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
        </div>
...
<center>
  <a href="bodyanimated.php" class="btn btn-dark" style="width: 300px;border-radius: 8px; font-size: 25px; font-weight: bold;">Ver más eventos...</a>
</center>