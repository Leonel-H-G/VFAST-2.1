    ...
    <nav class="navbar sticky-top navbar-expand-lg navbar-light bg-danger ">
      <div class="container-fluid">
        <a class="navbar-brand fw-bold text-light" href="escritorio Free.html">
          <img src="../img/vfastblanco.png" alt="" width="140" height="50" class="d-inline-block align-text-top">
         </a>
        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
          <ul class="navbar-nav">
            <li class="nav-item">
              <a class="nav-link active text-light" aria-current="page" href="escritorio Free.php">Inicio</a>
            </li>
            <li class="nav-item">
              <a class="nav-link text-light" href="escritorio Categorías.php">Categorías</a>
            </li>
            <li class="nav-item">
              <a class="nav-link text-light" href="escritorio Novedades.php">Novedades</a>
            </li>
            <li class="nav-item">
              <a class="nav-link text-light" href="escritorio Recomendaciones.php">Recomendaciones</a>
            </li>
            <li class="nav-item">
              <a class="nav-link text-light" href="escritorio Ayuda.php">Ayuda</a>
            </li>
            <li class="nav-item">
          <a class="nav-link bg-warning " style="border-radius: 15px; font-weight: bold;" href="index1Login.php">Iniciar Sesión</a>
        </li>
