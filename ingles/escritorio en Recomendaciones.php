...
<head>
    ...
    <title>| VFAST | Recommendations |</title>
...
<div class="contenedor_loader">
  ...
  <div class="card-body bg-dark text-light" style="font-weight: bold; border-radius: 30px; font-size: 55px;">
    <img src="../img/ubicacion.png" alt="" width="40px">RECOMMENDATIONS<img src="img/ubicacion.png" alt="" width="40px">
    <font color="crimson">
      <p class="card-title bg-light " style="font-weight: bold; border-radius: 30px; font-size: 30px;">WE ENCOURAGE YOU TO VISIT...</p>
    </font>
  </div>
</div></center>
<!--SUPERIOR-->
...
<div class="row row-cols-1 row-cols-md-2 g-4">
  ...
  <div class="col">
     ...
     <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d15050.129382642193!2d-99.1332049!3d19.4326018!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x4cff0c5cb291360c!2zWsOzY2Fsbw!5e0!3m2!1ses-419!2smx!4v1669860326181!5m2!1ses-419!2smx" style="border:0; height: auto; max-width: 100%; height: 210px; width: 320px;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
      ...
      <div class="card-body">
        <h5 class="card-title text-center bg-dark text-light" style="border-radius: 30px; font-size: 25px;">Information</h5>
        <font color="crimson">
        <p style="font-weight: bold; font-size: 20px;">Select your plan:</p></font>
      ...
      <h5>Start your visit...</h5>
        <p class="card-text bg-warning text-center" style=" border-radius: 30px; font-size: 20px; font-weight: bold; width: 600px; height: auto; max-width: 100%;">Contact: cocinacazuelas@gmail.com || 55****32**</p>
      </div>
    </div>
  </div>
<!--EVENTO 1-->
...
<!--EVENTO 2-->
  <div class="col">
    <div class="card" style="background-color: transparent; border-color: transparent;">
      ...
      <div class="card-body">
        <h5 class="card-title bg-dark text-center text-light" style="border-radius: 30px; font-size: 25px;">Information</h5
        ><font color="crimson">
        <p style="font-weight: bold; font-size: 20px;">Select your plan:</p></font>
        <div class="btn-toolbar" role="toolbar" aria-label="Toolbar with button groups" id="modulos">
        <div class="btn-group me-2" role="group" aria-label="First group">
      ...
      <h5>Start your visit...</h5>
        <p class="card-text bg-warning text-center" style=" border-radius: 30px; font-size: 20px; font-weight: bold; width: 600px; height: auto; max-width: 100%;">Contact: parquelastorres@gmail.com || 55****28**</p>
      </div>
    </div>
  </div>
